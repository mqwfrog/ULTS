...
class TC(nn.Module):
    def __init__(self, configs, device):
        ...
        # mqw-begin
        self.seq_transformer = Seq_Transformer(seq_size=self.timestep, patch_size=self.num_channels, dim=configs.TC.hidden_dim, depth=4, heads=4, mlp_dim=64, emb_dropout=0.)
        # mqw-end
